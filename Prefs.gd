...
func _ready() -> void:
	...
	_auto_load.pressed = Globals.preferences.auto_load
	_auto_save.pressed = Globals.preferences.auto_save
	...
	_show_numbers.pressed = Globals.preferences.show_numbers
	_show_outlines.pressed = Globals.preferences.show_outlines
...
func _on_save_pressed():
	...
	var updates: int = 0
	if Globals.preferences.auto_load != _auto_load.pressed:
		Globals.preferences.auto_load = _auto_load.pressed
		updates += 1
	if Globals.preferences.auto_save != _auto_save.pressed:
		Globals.preferences.auto_save = _auto_save.pressed
		updates += 1
	if Globals.preferences.columns != _columns.value:
		Globals.preferences.columns = _columns.value
		updates += 1
	...
	if Globals.preferences.rows != _rows.value:
		Globals.preferences.rows = _rows.value
		updates += 1
	if Globals.preferences.show_numbers != _show_numbers.pressed:
		Globals.preferences.show_numbers = _show_numbers.pressed
		updates += 1
	if Globals.preferences.show_outlines != _show_outlines.pressed:
		Globals.preferences.show_outlines = _show_outlines.pressed
		updates += 1
